...
def confidence_score(c):
	...
	"""
	if c.logprobs is not None and c.logprobs.content is not None:
...
if __name__ == "__main__":
    ...
    image_path = "MCTSNode_SIMULATED_0_screenshot_som.png"
        ...
        messages=[
            {
                ...
                "content": [
                    { 
						"type": "text", 
						"text": """You are a UI Assistant. Your goal is to help the user perform tasks using a web browser. You communicate with the user via chat, where the user provides instructions and you can send messages back. You have access to a web browser that both you and the user can see, and only you can interact with via specific commands. Review the user's instructions, the current state of the web page, and the history of interactions to determine the best next action to accomplish your current subtask. Your response will be interpreted and executed by a program; make sure to follow the formatting instructions precisely.
	...
	---
    scrollv(up: bool):
    - Description: Scroll vertically. If up is true, it scrolls up. Otherwise, it scrolls down. Dispatches a wheel event.
    - Examples:
	...
	- The attached image is the screenshot of the current web page. The controls with [bid] have been annotated within a colored rectangle with their corresponding bid values.
	...
	RootWebArea 'Dashboard / Magento Admin', focused
		[1] link+image 'Magento Admin Panel'
		navigation ''
			[4] menubar '', orientation='horizontal'
				[5] link '\ue604 DASHBOARD', class=['_active']
				[6] link '\ue60b SALES'
				[7] link '\ue608 CATALOG'
				[8] link '\ue603 CUSTOMERS'
				[9] link '\ue609 MARKETING'
				...
				[12] link '\ue60d STORES'
				[13] link '\ue610 SYSTEM'
				[14] link '\ue612 FIND PARTNERS & EXTENSIONS'
		banner ''
			heading 'Dashboard'
			[15] link '\ue600 admin', class=['admin__action-dropdown']
			[16] link '\ue607', class=['notifications-action', 'admin__action-dropdown']
			Section ''
				[25] textbox '\ue60c', class=['search-global-input']
		main ''
			StaticText 'Scope:'
			[17] button 'All Store Views', hasPopup='menu'
			[18] link '\ue633 What is this?', class=['admin__field-tooltip-action', 'action-help']
			Section ''
				[23] button 'Reload Data'
			Section ''
				...
				[24] link 'Go to Advanced Reporting \ue644', class=['action', 'action-advanced-reports']
			StaticText 'Chart is disabled. To enable the chart, click'
			[26] link 'here'
			StaticText '.'
			list  'Revenue $0.00 Tax $0.00 Shipping $0.00 Quantity 0'
			tablist '', multiselectable=False, orientation='horizontal'
				[31] tab+link 'The information in this tab has been changed. This tab contains invalid data. Please resolve this before saving. Loading... Bestsellers', expanded=True, selected=True, controls='grid_tab_ordered_products_content'
				[32] tab+link 'The information in this tab has been changed. This tab contains invalid data. Please resolve this before saving. Loading... Most Viewed Products', expanded=False, selected=False, controls='ui-id-1'
				[33] tab+link 'The information in this tab has been changed. This tab contains invalid data. Please resolve this before saving. Loading... New Customers', expanded=False, selected=False, controls='ui-id-2'
				[34] tab+link 'The information in this tab has been changed. This tab contains invalid data. Please resolve this before saving. Loading... Customers', expanded=False, selected=False, controls='ui-id-3'
			tabpanel 'The information in this tab has been changed. This tab contains invalid data. Please resolve this before saving. Loading... Bestsellers'
				table ''
					...
					rowgroup ''
						[120] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/catalog/product/edit/id/20/'
							gridcell 'Quest Lumaflex™ Band'
							gridcell '$19.00'
							gridcell '6'
						[121] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/catalog/product/edit/id/33/'
							gridcell 'Sprite Yoga Strap 6 foot'
							gridcell '$14.00'
							gridcell '6'
						[122] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/catalog/product/edit/id/29/'
							gridcell 'Sprite Stasis Ball 65 cm'
							gridcell '$27.00'
							gridcell '6'
						[123] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/catalog/product/edit/id/25/'
							gridcell 'Sprite Stasis Ball 55 cm'
							gridcell '$23.00'
							gridcell '5'
						[124] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/catalog/product/edit/id/13/'
							gridcell 'Overnight Duffle'
							gridcell '$45.00'
							gridcell '5'
			StaticText 'Lifetime Sales $0.00'
			StaticText 'Average Order $0.00'
			...
			table ''
				rowgroup ''
					row ''
						...
						columnheader 'Total'
				rowgroup ''
					[46] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/sales/order/view/order_id/299/'
						gridcell 'Sarah Miller'
						gridcell '5'
						gridcell '$194.40'
					[47] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/sales/order/view/order_id/65/'
						gridcell 'Grace Nguyen'
						gridcell '4'
						gridcell '$190.00'
					[48] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/sales/order/view/order_id/125/'
						gridcell 'Matt Baker'
						gridcell '3'
						gridcell '$151.40'
					[49] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/sales/order/view/order_id/136/'
						gridcell 'Lily Potter'
						gridcell '4'
						gridcell '$188.20'
					[50] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/sales/order/view/order_id/230/'
						gridcell 'Ava Brown'
						gridcell '2'
						gridcell '$83.40'
			...
			table ''
				rowgroup ''
					row ''
						...
						columnheader 'Uses'
				rowgroup ''
					[52] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/25/'
						gridcell 'tanks'
						gridcell '23'
						gridcell '1'
					[53] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/19/'
						gridcell 'nike'
						gridcell '0'
						gridcell '3'
					[54] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/1/'
						gridcell 'Joust Bag'
						gridcell '10'
						gridcell '4'
					[55] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/11/'
						gridcell 'hollister'
						gridcell '1'
						gridcell '19'
					[56] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/13/'
						gridcell 'Antonia Racer Tank'
						gridcell '23'
						gridcell '2'
			...
			table ''
				rowgroup ''
					row ''
						...
						columnheader 'Uses'
				rowgroup ''
					[58] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/11/'
						gridcell 'hollister'
						gridcell '1'
						gridcell '19'
					[59] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/1/'
						gridcell 'Joust Bag'
						gridcell '10'
						gridcell '4'
					[60] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/13/'
						gridcell 'Antonia Racer Tank'
						gridcell '23'
						gridcell '2'
					[61] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/25/'
						gridcell 'tanks'
						gridcell '23'
						gridcell '1'
					[62] row 'http://nlp-in-477-l.soe.ucsc.edu:7780/admin/search/term/edit/id/9/'
						gridcell 'WP10'
						gridcell '1'
						gridcell '1'
		contentinfo ''
			paragraph ''
				[19] link '\ue606', class=['link-copyright']
				StaticText 'Copyright © 2025 Magento Commerce Inc. All rights reserved.'
			paragraph  'Magento ver. 2.4.6'
			[20] link 'Privacy Policy'
			StaticText '|'
			[21] link 'Account Activity'
			StaticText '|'
			[22] link 'Report an Issue'
	```
	...
	### Explanation:
	The assistant clicked the content under the 'most viewed product' section. '31' is target control id. However, only the information "We couldn't find any records." is displayed.
	## step 1
